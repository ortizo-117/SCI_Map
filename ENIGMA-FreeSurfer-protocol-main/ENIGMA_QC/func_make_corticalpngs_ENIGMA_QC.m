...
%sliceSs = round(quantile(x,[.02 .05 .1 .2 .3 .4 .5 .6 .7 .8 .85 .9 .92]));
%sliceCs = round(quantile(y,[.02 .05 .1 .2 .3 .4 .5 .6 .7 .8 .85 .9 .92]));
%sliceAs = round(quantile(z,[.02 .05 .1 .2 .3 .4 .5 .6 .7 .8 .85 .9 .92]));
sliceSs = round(quantile(x,[.1 .2 .4 .5 .6 .8 .85 .9]));
sliceCs = round(quantile(y,[.1 .2 .4 .5 .6 .8 .85 .9]));
sliceAs = round(quantile(z,[.1 .2 .4 .5 .6 .8 .85 .9]));
%txts={'05';'10';'20';'30';'40';'50';'60';'70';'80';'90';'95'};
%txts={'05';'10';'20';'30';'40';'50';'60';'70';'80';'85';'90'};
%txts={'02';'05';'10';'20';'30';'40';'50';'60';'70';'80';'85';'90';'92'};
...
%% for each slice
   ...
   % caxis([1 64]);
    ...
    imadjust(colormap([bone(m1); FSmap]),[],[],0.4);
    ...
    close all;
        ...
        %txts={'05';'10';'20';'30';'40';'50';'60';'70';'80';'90';'95'}; %%%% CHANGED THIS AFM %%%%
        %txts={'02';'05';'10';'20';'30';'40';'50';'60';'70';'80';'90';'92'}; %%%% CHANGED THIS AFM %%%%
        %txts={'05';'10';'20';'30';'40';'50';'60';'70';'80';'85';'90'}; %%%% CHANGED THIS AFM %%%%
        %txts={'02';'05';'10';'20';'30';'40';'50';'60';'70';'80';'85';'90';'92'};
        txts={'10';'20';'40';'50';'60';'80';'85';'90'};
        %% for each slice
